...
type
  TFrmBrvColumnsEditor = class(TForm)
...
function EditGridColumns(Grid: TCustomGridView): Boolean;
begin
  with TFrmBrvColumnsEditor.Create(nil) do
  try
    Execute(Grid);
...
{ TFrmBrvColumnsEditor }

procedure TFrmBrvColumnsEditor.AddColumn;
begin
  FColumns.Add;
  RefreshView;
...
procedure TFrmBrvColumnsEditor.DeleteAllColumns;
const
...
procedure TFrmBrvColumnsEditor.DeleteColumn;
var
  I: Integer;
begin
  with ColumnsList do
...
procedure TFrmBrvColumnsEditor.CheckColumn;
var
  I: Integer;
begin
...
procedure TFrmBrvColumnsEditor.GetColumn;
var
  I: Integer;
begin
  with ColumnsList do
...
procedure TFrmBrvColumnsEditor.GetParams;
begin
  FColumns.Assign(FGrid.Columns);
  RefreshView
end;

procedure TFrmBrvColumnsEditor.MoveColumnDown;
var
  I: Integer;
begin
  with ColumnsList do
...
procedure TFrmBrvColumnsEditor.MoveColumnUp;
var
  I: Integer;
begin
  with ColumnsList do
...
procedure TFrmBrvColumnsEditor.PutColumn;
var
  I: Integer;
begin
  with ColumnsList do
...
procedure TFrmBrvColumnsEditor.PutParams;
begin
  FGrid.Columns := FColumns;
end;

procedure TFrmBrvColumnsEditor.RefreshView;
...
function TFrmBrvColumnsEditor.Execute(Grid: TCustomGridView): Boolean;
begin
  FGrid := Grid;
  GetParams;
...
procedure TFrmBrvColumnsEditor.EnableApply(Sender: TObject);
begin
...
procedure TFrmBrvColumnsEditor.DisableApply(Sender: TObject);
begin
...
procedure TFrmBrvColumnsEditor.FormCreate(Sender: TObject);
const
...
procedure TFrmBrvColumnsEditor.FormDestroy(Sender: TObject);
begin
  FColumns.Free;
end;

procedure TFrmBrvColumnsEditor.ColumnsListChange(Sender: TObject; Item: TListItem; Change: TItemChange);
begin
  if not (csDestroying in ComponentState) then RefreshView;
end;

procedure TFrmBrvColumnsEditor.ColumnsListChanging(Sender: TObject; Item: TListItem; Change: TItemChange; var AllowChange: Boolean);
begin
...
procedure TFrmBrvColumnsEditor.ColumnsListEnter(Sender: TObject);
begin
  FExceptCount := 0;
end;

procedure TFrmBrvColumnsEditor.ColumnsListKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Shift = [] then
    case Key of
      VK_INSERT:
...
procedure TFrmBrvColumnsEditor.IndexEditKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrmBrvColumnsEditor.OKButtonClick(Sender: TObject);
begin
  ApplyButtonClick(ApplyButton);
  ModalResult := mrOK;
end;

procedure TFrmBrvColumnsEditor.ApplyButtonClick(Sender: TObject);
begin
  CheckColumn;
  PutColumn;
  PutParams;
...
procedure TFrmBrvColumnsEditor.AddButtonClick(Sender: TObject);
begin
  CheckColumn;
  PutColumn;
  AddColumn;
...
procedure TFrmBrvColumnsEditor.DeleteButtonClick(Sender: TObject);
begin
  CheckColumn;
  PutColumn;
  DeleteColumn;
