...
type
  TFrmBrvHeaderEditor = class(TForm)
...
function EditGridHeader(Grid: TCustomGridView): Boolean;
begin
  with TFrmBrvHeaderEditor.Create(nil) do
  try
    Execute(Grid);
...
procedure TFrmBrvHeaderEditor.AddSection;
var
...
procedure TFrmBrvHeaderEditor.DeleteAllSections;
const
...
procedure TFrmBrvHeaderEditor.DeleteSection;
var
  S: TGridHeaderSection;
begin
  with SectionsTree do
...
procedure TFrmBrvHeaderEditor.CheckSection;
begin
...
procedure TFrmBrvHeaderEditor.GetSection;
var
  S: TGridHeaderSection;
begin
  with SectionsTree do
...
procedure TFrmBrvHeaderEditor.GetParams;
begin
  FSections.Assign(FGrid.Header.Sections);
  RefreshView;
end;

procedure TFrmBrvHeaderEditor.MoveSectionDown;
var
  S: TGridHeaderSection;
begin
  with SectionsTree do
...
procedure TFrmBrvHeaderEditor.MoveSectionLeft;
var
...
procedure TFrmBrvHeaderEditor.MoveSectionRight;
var
  S: TGridHeaderSection;
begin
  with SectionsTree do
...
procedure TFrmBrvHeaderEditor.MoveSectionUp;
var
  S: TGridHeaderSection;
begin
  with SectionsTree do
...
procedure TFrmBrvHeaderEditor.PutSection;
var
  S: TGridHeaderSection;
begin
  with SectionsTree do
...
procedure TFrmBrvHeaderEditor.PutParams;
begin
  FGrid.Header.Sections := FSections;
end;

procedure TFrmBrvHeaderEditor.RefreshView;
...
procedure TFrmBrvHeaderEditor.SelectSection(Section: TGridHeaderSection);
...
function TFrmBrvHeaderEditor.Execute(Grid: TCustomGridView): Boolean;
begin
  FGrid := Grid;
  GetParams;
...
procedure TFrmBrvHeaderEditor.EnableApply(Sender: TObject);
begin
...
procedure TFrmBrvHeaderEditor.DisableApply(Sender: TObject);
begin
...
procedure TFrmBrvHeaderEditor.FormCreate(Sender: TObject);
begin
  FSections := TGridHeaderSections.Create(nil, nil);
  SectionsTree.Items.Add(nil, 'Sections');
end;

procedure TFrmBrvHeaderEditor.FormDestroy(Sender: TObject);
begin
  FSections.Free;
end;

procedure TFrmBrvHeaderEditor.SectionsTreeChange(Sender: TObject; Node: TTreeNode);
begin
  if not (csDestroying in ComponentState) then RefreshView;
end;

procedure TFrmBrvHeaderEditor.SectionsTreeChanging(Sender: TObject; Node: TTreeNode; var AllowChange: Boolean);
begin
...
procedure TFrmBrvHeaderEditor.SectionsTreeEnter(Sender: TObject);
begin
  FExceptCount := 0;
end;

procedure TFrmBrvHeaderEditor.SectionsTreeKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if Shift = [] then
    case Key of
      VK_INSERT:
...
procedure TFrmBrvHeaderEditor.AddButtonClick(Sender: TObject);
begin
  CheckSection;
  PutSection;
  AddSection;
...
procedure TFrmBrvHeaderEditor.DeleteButtonClick(Sender: TObject);
begin
  CheckSection;
  PutSection;
  DeleteSection;
...
procedure TFrmBrvHeaderEditor.IndexEditKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrmBrvHeaderEditor.OKButtonClick(Sender: TObject);
begin
  ApplyButtonClick(ApplyButton);
  ModalResult := mrOK;
end;

procedure TFrmBrvHeaderEditor.ApplyButtonClick(Sender: TObject);
begin
  CheckSection;
  PutSection;
  PutParams;
